...
- `video.remotion.check_interval_min` throttles the latest-version checks for the per-run Remotion toolchain and remotion-dev/skills (`oma video compose`, `oma update`).
