...
5. **Вы координируете** — проверяете `.agent/brain/` на согласованность
...
### Knowledge Base
Результаты работы агентов сохраняются в `.agent/brain/`. Содержит планы, код, отчеты и заметки по координации.
...
3. **Проверяйте Knowledge Base** — проверьте `.agent/brain/` на согласованность API
